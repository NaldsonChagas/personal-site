...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    case4Title: 'Drogasil',
    case4Problem: 'Subscription feature was not in production and code was unmaintained.',
    case4Action: 'System recovery with PHP, Java microservices and RabbitMQ.',
    case4Result: 'Full recovery and production rollout of the subscription platform.',
    case5Category: 'Fintech',
    case5Title: 'Finnet Tecnologia',
    case5Problem: 'Bottlenecks in financial data processing workflows.',
    case5Action: 'Refactored core modules using Python. Built new applications from scratch with NestJS.',
    case5Result: 'Dramatic 85% performance boost in daily processing cycles.',
    case6Category: 'Bet',
    case6Title: 'EstrelaBet',
    case6Problem: 'Scaling legacy monolithic system for a modern application.',
    case6Action: 'Architected a new BFF from scratch using Node/Fastify.',
    case6Result: 'Significantly reduced maintenance, improved observability, and developer velocity.',
  ...
  pt: {
    ...
    case3Category: 'Fintech',
    case3Title: 'Banco Midway',
    case3Problem: 'Necessidade de features de alta concorrência como recarga de celulares móveis e débito automático em conta.',
    ...
    case4Title: 'Drogasil',
    case4Problem: 'Feature de assinatura de produtos não estava em produção e com código sem manuteção.',
    case4Action: 'Recuperação do sistema com microserviços PHP, Java e RabbitMQ.',
    case4Result: 'Recuperação e subida para produção completa da plataforma de assinaturas.',
    case5Category: 'Fintech',
    case5Title: 'Finnet Tecnologia',
    case5Problem: 'Gargalos em fluxos de processamento de dados financeiros.',
    case5Action: 'Refatoração de módulos centrais com Python. Criação do zero de novas aplicações com NestJS.',
    case5Result: 'Ganho de 85% de performance nos ciclos diários de processamento.',
    case6Category: 'Bet',
    case6Title: 'EstrelaBet',
    case6Problem: 'Escalabilidade de sistema monolítico legado para aplicação moderna.',
    case6Action: 'Arquitetura de um novo BFF do zero com Node/Fastify.',
    case6Result: 'Redução significativa na manutenção, observabilidade e melhoria na velocidade de desenvolvimento.',
